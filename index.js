...
console.log("Step 1", copy(originalFlavors));
...
console.log("Step 2", is31Flavors(originalFlavors));
...
console.log("Step 3", addFlavor(originalFlavors, "Rainbow Sherbert"));
...
console.log("Step 4", removeLastFlavor(originalFlavors))
...
console.log("task 5", getFlavorByIndex(2))
...
console.log("Step 6", removeFlavorByName(originalFlavors, "Rocky Road"));
...
console.log("Step 7", filterByWord(originalFlavors, "chocolate"))
